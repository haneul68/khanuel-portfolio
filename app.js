  ...
  return [
    {
      ...
      links: [
        ...
        { label: "??? ??", url: "https://drive.google.com/drive/folders/1pKR-7ToKYZ0Pp2ic_i1ULvNALnNmsVV0?usp=sharing" }
      ],
      portfolioTemplateVersion: 12,
      sections: [
        { type: "text", title: "???? ??", keywords: ["Unity", "C#", "Photon Fusion", "3D Arena", "2? ?", "PC"], text: "Chaos Arena? 3D ????? ???? ???? ??? ??? ??? ???? ????? ?? ???????. ?? ???? ??? ????, ???? ??? ?? ??? ???? ??????. ???? ??, ??, ??, ?? ?? ??, ?? ?? ??, ????? ??, ??? ??, ??? ??? UI ???? ?????." },
        { type: "text", title: "?? ??", keywords: ["? ??", "??", "??? ??", "??? ??", "?? ??"], text: "????? ?? ???? ??? ? ???? ?? ???? ????, ??????????? ? ???? ??? ??? ?????. ??? ??? ??? ?? ??? ???? ????, ???? ?? ??? Q/E/R ??, F ???? ??? ??? ???? ?????." },
        { type: "showcase", title: "??? ??", layout: "media-left", blocks: [
          { kind: "media", size: "feature", media: "assets/project-chaos-ingame-ui.png", title: "??? ?? ??", text: "??? ??, ? ??, ???, ??/??, ?? ? ??? ?? ??? ?? ?? ?????.", caption: "?? ??? ???? ?? ??? ? ???? ????? ??????." },
          { kind: "text", size: "normal", title: "?? ??", text: "????? ???? ???? ??? ??, ?????, ?? ??, ?? ???? ????? ???? ??? ??? ?? ??? ????." },
          { kind: "text", size: "normal", title: "?? ??", text: "Photon Fusion ???? ??? ?? ??? ????, ????????? ?? ???? ??? ???? ?? ??? ??????." }
        ] },
        { type: "video", title: "?? ??? ??", url: "https://drive.google.com/drive/folders/1pKR-7ToKYZ0Pp2ic_i1ULvNALnNmsVV0?usp=sharing" },
        { type: "showcase", title: "??? ?? ??", layout: "bento", blocks: [
          { kind: "media", size: "normal", media: "assets/project-chaos-main.png", title: "?? ??", text: "? ??? ?? ??? ???? ?????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-room-create.png", title: "? ???", text: "? ??, ????, ??, ?? ??? ??? ?????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-lobby.png", title: "??", text: "? ??, ???? ??, ??? ?? ??? ???? ?????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-character-select.png", title: "??? ??", text: "???, ???, ??? ? ??? ???? ?????." }
        ] },
        { type: "architecture", title: "?? ??? ??", flowTitle: "Match Flow", systemTitle: "Runtime Modules", note: "???? ??? NetworkInputData? ????, ?? ???????? ??? StateAuthority ???? ????? ??????. ??? ??? RoundManager? ??? ????, ???? ??? Character ?? ???? ActionLock?? ??? ??????.", flow: ["Room|? ?? ?? ??", "Lobby|???? ??? ?? ?? ??", "Select|??? ??", "Round|??? ??? ?? ?? ??", "Result|??? ??? ?? ??"], systems: ["NetworkInputData|??, ??, ??, ????, ??, ??, Q/E/R ?? ??", "NetworkThirdPersonController|?? ?? ??, ??? ??, ??, ?? ??", "PlayerCharacter|HP, Mana, ?, ??, ??, ?? ?? ??", "CharacterCombat|?? ?? ??, ?? ??, ???? ?? ??? ??", "CharacterActionLock|??, ??, ??, ??, ?? ?? ??", "RoundManager|??? ??, ??, ???, ??? ??? ?? ??"], domains: ["Player Control|??, ??, ????, ??", "Combat|?? ?? ??, ????, ?? ???", "Skill|Q/E/R ?? ??? ???/?? ??", "Network|StateAuthority, RPC, ???? ??", "UI|??, ??? ??, ??? HUD"] },
        { type: "features", title: "?? ??", features: ["?? ??? ?? ?? ??", "???? ??, ??, ????, ?? ??", "???? ??? ?? ?? ? ?? ?? ??", "??? ??? ??? ???? ?? ?? ?? ??", "Photon Fusion ?? ???? ??? ?? ???", "??? ?? ??? ?? ?? ??", "??? ??? ?? UI ???"] },
        { type: "showcase", title: "???? ?? ??", layout: "media-left", blocks: [
          { kind: "media", size: "feature", media: "assets/project-chaos-assassin-basic.png", title: "??? ?? ?? ??", text: "?? ???? ?? ?? ??? ????, ????? ??? ??? ?? ??? ????? ??????.", caption: "?? ?? ?, ?? ??, ???? ?? ??? ??????." },
          { kind: "text", size: "normal", title: "?? ??", text: "CharacterCombat?? AttackData? ???? ?? ??, ???, ??, ???, ?? ???? ??????. ? ??? ??? ?? ??? ??? ???? ??? ??????." },
          { kind: "text", size: "normal", title: "??? ??", text: "???? ?? ??? ??? ??? ??? ??? ??????. ?? ?? ??? CharacterActionLock? ?? ??, ??, ??, ?? ??? ??? ?? ??????." }
        ] },
        { type: "showcase", title: "??? ???", layout: "bento", blocks: [
          { kind: "media", size: "normal", media: "assets/project-chaos-skill-q.png", title: "Q ??", text: "?? ??, ???, ?? ??? ??? ? ?? ?? ???? ?????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-skill-e.png", title: "E ??", text: "???? ??? ?? ??? ?? ?? ???? ????? ??????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-skill-r.png", title: "R ??", text: "??? ?? ? ??? ?? ??? ??? ?? ??? ???? ?? ??????." },
          { kind: "media", size: "normal", media: "assets/project-chaos-dash-f.png", title: "F ???", text: "CapsuleCast? ???? ????, ?? ??? ?? ??? ???? ???? ??????." }
        ] },
        { type: "showcase", title: "??? ??", layout: "media-left", blocks: [
          { kind: "media", size: "feature", media: "assets/project-chaos-brute-basic.png", title: "??? ?? ??", text: "??? ?? ???? ?? ??? ????? ??? ?? ???? ??????.", caption: "???? ?? ??? ????? ?? ??? ?? ??? ?????." },
          { kind: "text", size: "normal", title: "???? ??", text: "???? ?? ??? ??, ???? ??? ?? ?? ??? ???? ??? ??? ??????. ??? ??? ? ?? ??? ????, ? ?????? ?? ??? ???? ?? ??? ??????? ?? ???? ??????." },
          { kind: "text", size: "normal", title: "????? ??", text: "?? ??, ?? ??, ?? ??? ?????? ????, ?? ??? ????? ??? ???? ?? ????? ??????." }
        ] },
        { type: "text", title: "????? ??", keywords: ["Photon Fusion", "NetworkBehaviour", "INetworkInput", "StateAuthority", "RPC"], text: "NetworkInputData? ??, ??, ??, ??, Q/E/R ??? ?? ????, NetworkThirdPersonController? ?? ??? ?? ???? ???? ?????. ?? ?? ??? StateAuthority ???? ????, ?????? ????? ?? ???????? ??? ?? ??? RPC? ???????." },
        { type: "text", title: "??? ??", keywords: ["RoundManager", "Character Select", "Preparation", "Playing", "Score"], text: "RoundManager? ??, ??? ??, ??, ??? ??? ???? ??? ??? ?? ??? ?????. ??? ?? ?? ????? ?? ??? ?????, ??? ??? ?? ??? ????? ????? ??????." },
        { type: "text", title: "UI ???", keywords: ["Lobby UI", "Room UI", "Character Select", "In-game HUD"], text: "??? ??? ?? UI ???? ??????. ? ??, ??, ???? ??, ??? ??, ??? ??, ??/??, ?? ? ???? ?? ?? ???? ????? ??? ??? ??? ??? ? ?? ??????." },
        { type: "features", title: "?? ?? ??", features: ["??, ??, ?? ??? ??? ??? CharacterActionLock?? ?? ?? ??", "StateAuthority ???? ?? ?? ??? ??? ?????? ?? ??? ??", "?? ?? ?? ????? ???? ??? ?? ???? ??", "?? ? ??? ??? ?? ?? CapsuleCast ?? ?? ?? ??", "??? ??? RoundManager? ?? UI? ?? ??? ?? ??"] },
        { type: "text", title: "?? ?", text: "????? ????? ??? ??? ???? ??? ??, ??, ?????, ??, UI? ?? ???? ?????? ????? ?? ?????. ?? ???? ???? ?? ????? ???? ??, ?? ??, ?? ???, ?? ? ?? ??, ??? ???? ?? ??? ? ????? ????? ?? ??????." },
        { type: "text", title: "??? ??", text: "???? ???? ?? ????? ?? ?? ??? ? ????, ???? ?? ???? UI ???? ???? ??? ?????. ?? ??? ??? ??? ??? ? ??? ? ???? ??? ??? ? ???? ???? ??? ? ????." }
      ]
    },
    {
...
function upgradeChaosArenaProject(data) {
  ...
  const current = data.projects[index];
  if ((current.portfolioTemplateVersion || 0) >= 12 && Array.isArray(current.sections) && current.sections.some(section => section.title === "???? ?? ??")) return false;
  data.projects[index] = {
    ...mergeProjectDefaults(current, template),
